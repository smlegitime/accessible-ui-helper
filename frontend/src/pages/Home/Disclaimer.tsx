...
/**
 * Legal disclaimer at the bottom right of home page
 * @param setOpen - React state setter for if disclaimer is visible or not
 * @returns React component with the disclaimer
 */
export function DisclaimerCard({setOpen}: {setOpen: React.Dispatch<React.SetStateAction<boolean>>}) {
    return (
